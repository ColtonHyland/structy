// Write a function, closestCarrot, that takes in a grid, a starting row,
// and a starting column. In the grid, 'X's are walls, 'O's are open spaces,
// and 'C's are carrots. The function should return a number representing
// the length of the shortest path from the starting position to a carrot.
